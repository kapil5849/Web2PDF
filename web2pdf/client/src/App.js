    ...
    return (
      <div className="App">
        ...
        <div className="form-div">
          ...
          <div className="heading">Website to PDF Convertor</div>
          ...
          <div className="logo-wrapper-2">
            <a href="https://github.com/kapil5849" target='_blank'>
              <img alt="logo" className="logo" src={githubSVG} />
            </a>
            <a href="https://www.linkedin.com/in/kapil--vaishnav" target='_blank'>
              <img
                alt="logo"
                className="logo"
                src={linkedinSVG}
          ...
          <div className='name'>
            Developed by <span>🖤</span> and <span>🍵</span>
            <a href='https://twitter.com/kapil__vaishnav' target='_blank' className="author-link">
              Kapil Vaishnav
            </a>
          </div>
        </div>
